# Casaubon's Commentary on Strabo's Γεωγραφικά
...
- Translation:
- Summary: Casaubon makes a note on the word choice of the word χάριν, explaining why he thinks this word was written neither by Strabo nor by Eratosthenes (whom Strabo is of course referencing here).
...
- Translation:
- Summary: Casaubon's manuscript sources have ἀέιδειν, which is more poetic, instead of ᾄδειν (e.g. the second word of the *Iliad*, ἄειδε).
